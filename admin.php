...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
		...
		<div id="fh5co-tours" class="fh5co-section-gray">
			<div class="container">
				...
				<!--div class="row row-bottom-padded-md">
					...
					<div class="col-md-6 animate-box">
						<img class="img-responsive" src="images/about_banner.jpg" alt="travel">
					</div-->
					<div><div class="btn-group-justified"  style="height:70px; width:800px;  margin:0 auto;"  >
 <a href="adminadd.php" class="btn btn-primary">Add package</a>
  <a href="admindelete.php" class="btn btn-primary">Delete package</a>
	...
	<script src="js/minicart.jss"></script>
	<script>
        w3ls.render();
	...
	<script type="text/javascript" src="js/move-top.jss"></script>
